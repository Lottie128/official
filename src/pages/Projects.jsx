...
const Projects = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Projects | ZeroAI Technologies Inc</title>
        <meta
          name="description"
          content="Innovative automation and robotics projects including industrial systems, service robots, agricultural tech, and educational kits."
        />
      </Helmet>
      ...
      <section className="section pt-32">
        <div className="container-custom">
          ...
          >
            <h1 className="heading-xl mb-4">Our Projects</h1>
              ...
              >
                <span
                  className={`inline-block px-3 py-1 rounded-full text-xs font-medium mb-4 ${
                    categoryColors[project.category] || 'bg-gray-100 dark:bg-gray-800'
                  }`}
                >
                  {project.category}
                </span>
                <h3 className="heading-sm mb-3">{project.name}</h3>
